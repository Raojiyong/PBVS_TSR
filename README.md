...
Note that the `pretrained_model.pth` is trained on the merged dataset, so you need to follow `utils/merge_image.py` and merge the training dataset first in the
training stage.
